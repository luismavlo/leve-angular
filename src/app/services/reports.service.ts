...
export class ReportsService {
  ...
  getNumberSales(initDate: string, endDate: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:3000/api/v1/sales/report`, {
  ...
  getNumberProduction(initDate: string, endDate: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:3000/api/v1/lots/report/production`, {
      headers: tokenHeader.headers,
      params,
    });
  }
  ...
  getAdminExpenses(initDate: string, endDate: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:3000/api/v1/expenses/report/admin`, {
      headers: tokenHeader.headers,
      params,
    });
  }
  ...
  getAdvertisingExpenses(initDate: string, endDate: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:3000/api/v1/expenses/report/advertising`, {
      headers: tokenHeader.headers,
      params,
    });
  }
  ...
  getOtherExpenses(initDate: string, endDate: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:3000/api/v1/expenses/report/other`, {
      headers: tokenHeader.headers,
      params,
    });
  }
  ...
  getOperationalExpenses(initDate: string, endDate: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:3000/api/v1/expenses-per-lots/report/operational`, {
      headers: tokenHeader.headers,
      params,
    });
  }
  ...
  getProceeds(initDate: string, endDate: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:3000/api/v1/sales/report/proceeds`, {
      headers: tokenHeader.headers,
      params,
    });
  }
  ...
  getNumberClients(initDate: string, endDate: string): Observable<any> {
    ...
    return this.http.get(`http://localhost:3000/api/v1/clients/report`, {
      headers: tokenHeader.headers,
      params,
    });
  }
  ...
  getLotsReportProceedsExpense(): Observable<ReportLotExpenseProceeds> {
    return this.http.get<ReportLotExpenseProceeds>(
      `http://localhost:3000/api/v1/lots/report/expeses-proceeds`,
      {
        headers: tokenHeader.headers,
      }
    );
  ...
  getReportProceedsVsExpenses(
    ...
    return this.http.get<ProceedsVsExpense>(
      `http://localhost:3000/api/v1/sales/report/abstract/proceeds/expenses`,
      {
        headers: tokenHeader.headers,
        params,
      }
